...
namespace ChartApp.Actors
{
    ...
    {
        private static readonly IDictionary<CounterType, Func<PerformanceCounter>> CounterGenerators = new Dictionary<CounterType, Func<PerformanceCounter>>
        {
        ...
        private static readonly IDictionary<CounterType, Func<Series>> CounterSeries = new
            Dictionary<CounterType, Func<Series>>
        {
        ...
        private IDictionary<CounterType, IActorRef> _counterActors;
        ...
        public PerformanceCounterCoordinatorActor(IActorRef chartingActor, IDictionary<CounterType, IActorRef> counterActors)
        {
            ...
            Receive<Watch>(watch =>
            {
                ...
                {
                    _counterActors[watch.Counter] = Context.ActorOf(
